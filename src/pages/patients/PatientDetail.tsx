  ...
  return (
    <div className="flex gap-3">
      <div className="flex flex-col items-center">
        ...
        {!isLast && <div className="w-px flex-1 bg-slate-100 dark:bg-slate-800 mt-1" />}
      </div>
...
export default function PatientDetail() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden" ref={printRef}>
      <div className="flex items-center gap-3 px-6 py-4 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 shrink-0 flex-wrap">
        <Button
          variant="outline"
          size="sm"
          onClick={() => navigate("/patients")}
        ...
        <div className="flex items-center gap-2 text-sm text-slate-400 dark:text-slate-500">
          ...
          <span>›</span>
          <span className="text-slate-900 dark:text-slate-100 font-semibold">{p.name}</span>
        </div>
      </div>

      <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-4 bg-slate-50 dark:bg-slate-950">
        <Card className="border-slate-200 dark:border-slate-700 dark:bg-slate-900 overflow-visible">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-2 mt-2 flex-wrap">
                  ...
                  <Badge className="text-[11px] font-bold bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800">
                    {p.department}
                  </Badge>
                  <Badge className="text-[11px] font-bold bg-green-50 dark:bg-green-950 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800">
                    HIPAA Verified
                  </Badge>
                  <Badge className="text-[11px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700">
                    {p.ward} · {p.bed}
                  </Badge>
                </div>
              </div>
              <div className="flex gap-6 shrink-0">
                {[
                  ...
                  <div key={v.label} className="text-center">
                    <div className={`text-xl font-extrabold font-mono tracking-tight ${v.alert ? "text-red-500" : "text-slate-900 dark:text-slate-100"}`}>
                      {v.value}
                    </div>
              ...
              <CardContent className="px-5 pb-5">
                <div className="grid grid-cols-4 gap-3">
                  {[
                    ...
                    return (
                      <div key={vital.label} className="bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl p-3">
                        ...
                        <div className={`text-lg font-extrabold font-mono ${vital.alert ? "text-red-500" : "text-slate-900 dark:text-slate-100"}`}>
                          {vital.value}
              ...
              <CardContent className="px-5 pb-5">
                <div className="flex flex-col gap-2">
                  {p.medications.map((med) => (
                    <div
                      key={med.id}
                      className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl"
                    >
                      <div>
                      ...
                      <Badge className="bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800 text-[11px] font-bold">
                        {med.frequency}
                      </Badge>
                    </div>
                  ))}
                ...
                <div className="flex flex-col gap-0">
                  {[
                    ...
                    return (
                      ...
                      >
                        <Icon className="w-3.5 h-3.5 text-slate-300 dark:text-slate-600 shrink-0 mt-0.5" />
                        <div className="flex-1 min-w-0">
                      ...
                      <div>
                        ...
                        <div className="flex gap-1 flex-wrap">
                          {p.allergies.map((a) => (
                            <Badge
                              key={a}
                              className="bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 border-red-200 dark:border-red-800 text-[10px] font-bold"
                            >
                              {a}
                            </Badge>
                          ))}
            ...
            <Card className="border-slate-200 dark:border-slate-700 dark:bg-slate-900">
              ...
              <CardContent className="px-5 pb-5">
                <div className="flex flex-col gap-3">
                  {[
                    { initials: "SR", name: "Dr. S. Raina", role: "Senior Physician · Lead", color: "bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-400" },
                    { initials: "PK", name: "Dr. P. Kumar", role: "Cardiologist", color: "bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-400" },
                    { initials: "NG", name: "Nurse Gita", role: "ICU Nurse · Primary", color: "bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-400" },
                  ].map((member) => (
